...
mod tests {
    ...
    fn test_keyword_recognition() {
        ...
        assert_eq!(TokenKind::from_keyword("mut"), Some(TokenKind::Mut));
        assert_eq!(TokenKind::from_keyword("if"), Some(TokenKind::If));
        assert_eq!(TokenKind::from_keyword("in"), Some(TokenKind::In));
        assert_eq!(TokenKind::from_keyword("dyn"), Some(TokenKind::Dyn));
        assert_eq!(TokenKind::from_keyword("_"), Some(TokenKind::Underscore));
        assert_eq!(TokenKind::from_keyword("stream"), Some(TokenKind::Stream));
